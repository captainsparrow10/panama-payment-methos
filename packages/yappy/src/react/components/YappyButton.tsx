...
} from '../hooks/useYappyWebComponent.js';
import { YappyButtonTheme } from '../../types.js';
...
/**
 * Props for the `YappyButton` component.
 *
 * @example
 * ```tsx
 * <YappyButton
 ...
 * @returns The rendered Yappy button or offline fallback.
 *
 * @example
 * ```tsx
