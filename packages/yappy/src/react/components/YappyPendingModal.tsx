...
import type { YappyPendingStatus } from '../hooks/useYappyPendingCheck.js';
...
/**
 * Props for the `YappyPendingModal` component.
 *
 * @example
 * ```tsx
 * <YappyPendingModal
 ...
 * @returns The rendered modal dialog, or `null` when status is 'idle'.
 *
 * @example
 * ```tsx
...
export function YappyPendingModal({
  ...
  const getDefaultError = (): string => {
    ...
    switch (status) {
      ...
      default: return 'Ocurrio un error con tu pago.';
    }
  };
          ...
          <>
            <header>
              ...
              <p id="yappy-modal-description">
                Te enviamos una notificacion a tu aplicacion de Yappy para confirmar el pago.
              </p>
            </header>

            <section aria-label="Instrucciones">
              <ol>
                <li>Abre tu aplicacion de Yappy</li>
                <li>Confirma el pago en la notificacion</li>
                <li>Regresa aqui para ver tu orden</li>
              </ol>
            </section>
