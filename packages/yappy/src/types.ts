...
export enum YappyErrorCode {
  ...
  /** Algo salio mal. Intenta nuevamente. */
  E008 = 'E008',
  /** ID de la orden mayor a 15 digitos. Ensure orderId is max 15 alphanumeric chars. */
  E009 = 'E009',
...
export const YAPPY_ERROR_MESSAGES: Record<YappyErrorCode, string> = {
  [YappyErrorCode.E002]: 'Algo salio mal. Intenta nuevamente.',
  [YappyErrorCode.E005]: 'Este numero no esta registrado en Yappy.',
  [YappyErrorCode.E006]: 'Algo salio mal. Intenta nuevamente.',
  [YappyErrorCode.E007]: 'El pedido ya ha sido registrado.',
  [YappyErrorCode.E008]: 'Algo salio mal. Intenta nuevamente.',
  [YappyErrorCode.E009]: 'ID de la orden mayor a 15 digitos.',
  [YappyErrorCode.E010]: 'El valor de los montos no es el correcto.',
  [YappyErrorCode.E011]: 'Error en los campos de URL.',
  [YappyErrorCode.E012]: 'Algo salio mal. Intenta nuevamente.',
  [YappyErrorCode.E100]: 'Solicitud invalida. Verifica los datos enviados.',
};
 ...
 * @example
 * ```ts
 * const response = await http.post<ValidateMerchantResponse>('/payments/validate/merchant', body);
 ...
 * @example
 * ```ts
 * const response = await http.post<CreateOrderResponse>('/payments/payment-wc', body, {
 *   headers: { Authorization: token },
 * });
 * const { transactionId, token: wcToken, documentName } = response.data.body;
 * ```
 */
 ...
 * @example
 * ```ts
 * const result: YappyCheckoutResult = {
 *   transactionId: 'TXN-123',
 *   token: 'wc-token-xyz',
 *   documentName: 'doc-abc',
 * };
 * btnYappy.eventPayment(result);
 * ```
 */
 ...
 * @example
 * ```ts
 * const payload: YappyWebhookPayload = {
 *   orderId: 'A3KX9MZQ1BPRY7W',
 ...
 * @example
 * ```ts
 * const config: YappyButtonConfig = {
 ...
 * @example
 * ```ts
 * const params: YappyPaymentParams = {
 *   transactionId: 'TXN-123',
 *   token: 'wc-token-xyz',
 *   documentName: 'doc-abc',
 * };
